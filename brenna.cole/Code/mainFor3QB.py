...
filename = "D:\\Users\\bcole\\Thesis\\ThreeQBResults3.txt"
...
for qc in matched_circs:
    filename2 = "D:\\Users\\bcole\\Thesis\\ThreeQBMatches_Orig\\match" + str(i) + ".txt"
...
for qc in reduced_circs:
    filename2 = "D:\\Users\\bcole\\Thesis\\ThreeQBMatches_Reduced\\match" + str(i) + ".txt"
    file2 = open(filename2, "w+")
    file2.write(qc.qasm())
    file2.close()
    i = i + 1
