...
struct s_prob {
    //int index;
    int n_x_err, n_z_err, n_total_err; // TODO: Maybe replace index with this
    float probability, cumulative;  // TODO: add or remove cumulative prob
...
int q_comp(const void *p1, const void *p2) {
    ...
    if (a < b) { return -1; }  // TODO: return and fix this if the sort order is backwards
...
*/
    ...
    /*for (int i = 0; i < total_num_iter; i++)
    {
        printf("Index %f: %f", probList[i][0], probList[i][1]);
    }*/
